...
function playTrailer() {
    ...
    // URL del tráiler (cambia esto por el enlace del tráiler oficial)
    let trailerURL = "https://www.youtube.com/embed/nqSQUrlnB9s?autoplay=1"; // Utiliza el formato de enlace adecuado para iframe
